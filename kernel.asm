...
801041ea:	74 3c                	je     80104228 <acquire+0x78>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104202:	75 f4                	jne    801041f8 <acquire+0x48>
  ...
  __sync_synchronize();
80104204:	0f ae f0             	mfence 

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104207:	8b 45 08             	mov    0x8(%ebp),%eax
8010420a:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
  getcallerpcs(&lk, lk->pcs);
80104211:	83 c0 0c             	add    $0xc,%eax
  // past this point, to ensure that the critical section's memory
  // references happen after the lock is acquired.
  __sync_synchronize();
  ...
  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104214:	89 50 fc             	mov    %edx,-0x4(%eax)
  getcallerpcs(&lk, lk->pcs);
80104217:	89 44 24 04          	mov    %eax,0x4(%esp)
8010421b:	8d 45 08             	lea    0x8(%ebp),%eax
8010421e:	89 04 24             	mov    %eax,(%esp)
80104221:	e8 2a ff ff ff       	call   80104150 <getcallerpcs>
}
80104226:	c9                   	leave  
80104227:	c3                   	ret    
void
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
80104228:	c7 04 24 23 73 10 80 	movl   $0x80107323,(%esp)
8010422f:	e8 2c c1 ff ff       	call   80100360 <panic>
...
8010431f:	c9                   	leave  
  ...
  popcli();
80104320:	e9 6b ff ff ff       	jmp    80104290 <popcli>
