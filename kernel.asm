...
80100393:	68 4d 6f 10 80       	push   $0x80106f4d
...
801003a1:	e8 ba 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a6:	c7 04 24 46 74 10 80 	movl   $0x80107446,(%esp)
...
801003d0:	68 69 6f 10 80       	push   $0x80106f69
...
80100540:	68 6d 6f 10 80       	push   $0x80106f6d
...
801005a9:	0f b6 92 98 6f 10 80 	movzbl -0x7fef9068(%edx),%edx
  }while((x /= base) != 0);
...
801007b8:	b8 28 00 00 00       	mov    $0x28,%eax
    ...
    case 's':
      if((s = (char*)*argp++) == 0)
        s = "(null)";
801007bd:	bf 80 6f 10 80       	mov    $0x80106f80,%edi
...
801007c7:	68 87 6f 10 80       	push   $0x80106f87
...
80100996:	68 90 6f 10 80       	push   $0x80106f90
...
80100a5a:	75 cf                	jne    80100a2b <exec+0x4b>
  ...
  if((pgdir = setupkvm()) == 0)
80100a5c:	e8 8f 5e 00 00       	call   801068f0 <setupkvm>
...
80100aec:	e8 8f 60 00 00       	call   80106b80 <allocuvm>
...
80100b22:	e8 99 5f 00 00       	call   80106ac0 <loaduvm>
...
80100b41:	e8 5a 61 00 00       	call   80106ca0 <freevm>
...
80100b81:	e8 fa 5f 00 00       	call   80106b80 <allocuvm>
...
80100b98:	e8 03 61 00 00       	call   80106ca0 <freevm>
...
80100bcd:	e8 4e 61 00 00       	call   80106d20 <clearpteu>
  sp = sz;
...
80100c25:	e8 46 62 00 00       	call   80106e70 <copyout>
...
80100c89:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c8f:	e8 dc 61 00 00       	call   80106e70 <copyout>
...
80100d09:	e8 92 5c 00 00       	call   801069a0 <switchuvm>
  freevm(oldpgdir);
80100d0e:	89 3c 24             	mov    %edi,(%esp)
80100d11:	e8 8a 5f 00 00       	call   80106ca0 <freevm>
  return 0;
...
80100d36:	68 a9 6f 10 80       	push   $0x80106fa9
...
80100dfb:	68 b0 6f 10 80       	push   $0x80106fb0
...
80100ed2:	68 b8 6f 10 80       	push   $0x80106fb8
...
80100fb2:	68 c2 6f 10 80       	push   $0x80106fc2
...
801010d0:	68 cb 6f 10 80       	push   $0x80106fcb
...
801010dd:	68 d1 6f 10 80       	push   $0x80106fd1
...
80101194:	68 db 6f 10 80       	push   $0x80106fdb
...
801012c4:	68 f1 6f 10 80       	push   $0x80106ff1
...
80101395:	68 01 70 10 80       	push   $0x80107001
...
80101454:	68 14 70 10 80       	push   $0x80107014
...
8010146c:	68 27 70 10 80       	push   $0x80107027
...
80101483:	68 2e 70 10 80       	push   $0x8010702e
...
801014d9:	68 84 70 10 80       	push   $0x80107084
...
801015a3:	68 34 70 10 80       	push   $0x80107034
...
8010171a:	68 4c 70 10 80       	push   $0x8010704c
...
80101727:	68 46 70 10 80       	push   $0x80107046
...
80101777:	68 5b 70 10 80       	push   $0x8010705b
...
80101e78:	68 3e 76 10 80       	push   $0x8010763e
...
80101f80:	68 e0 70 10 80       	push   $0x801070e0
...
80101f8d:	68 d7 70 10 80       	push   $0x801070d7
...
80101fa6:	68 f2 70 10 80       	push   $0x801070f2
...
8010219e:	68 f6 70 10 80       	push   $0x801070f6
...
801021ab:	68 21 71 10 80       	push   $0x80107121
...
801021b8:	68 0c 71 10 80       	push   $0x8010710c
...
80102227:	68 40 71 10 80       	push   $0x80107140
...
80102355:	68 72 71 10 80       	push   $0x80107172
...
801023bb:	68 78 71 10 80       	push   $0x80107178
...
8010252f:	0f b6 8a a0 72 10 80 	movzbl -0x7fef8d60(%edx),%ecx
  shift ^= togglecode[data];
80102536:	0f b6 82 a0 71 10 80 	movzbl -0x7fef8e60(%edx),%eax
    // Last character was an E0 escape; or with 0x80
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
8010254c:	83 e1 08             	and    $0x8,%ecx
  ...
  shift ^= togglecode[data];
  c = charcode[shift & (CTL | SHIFT)][data];
8010254f:	8b 04 85 80 71 10 80 	mov    -0x7fef8e80(,%eax,4),%eax
...
8010257c:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
8010257f:	0f b6 82 a0 72 10 80 	movzbl -0x7fef8d60(%edx),%eax
...
80102761:	68 a0 73 10 80       	push   $0x801073a0
...
80102783:	68 cc 73 10 80       	push   $0x801073cc
...
80102b4a:	68 dc 73 10 80       	push   $0x801073dc
...
80102da7:	68 e0 73 10 80       	push   $0x801073e0
...
80102e73:	68 ef 73 10 80       	push   $0x801073ef
80102e78:	e8 f3 d4 ff ff       	call   80100370 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102e7d:	83 ec 0c             	sub    $0xc,%esp
80102e80:	68 05 74 10 80       	push   $0x80107405
...
80102e9f:	68 20 74 10 80       	push   $0x80107420
80102ea4:	e8 b7 d7 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102ea9:	e8 c2 28 00 00       	call   80105770 <idtinit>
...
80102ed3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102ed6:	e8 a5 3a 00 00       	call   80106980 <switchkvm>
  seginit();
80102edb:	e8 c0 38 00 00       	call   801067a0 <seginit>
  lapicinit();
...
80102f46:	e8 25 2b 00 00       	call   80105a70 <uartinit>
  pinit();         // process table
80102f4b:	e8 20 09 00 00       	call   80103870 <pinit>
  tvinit();        // trap vectors
80102f50:	e8 7b 27 00 00       	call   801056d0 <tvinit>
  binit();         // buffer cache
...
8010303a:	e8 51 fe ff ff       	call   80102e90 <mpmain>
  ...
  if(!ismp)
    timerinit();   // uniprocessor timer
8010303f:	e8 2c 26 00 00       	call   80105670 <timerinit>
...
80103078:	68 48 74 10 80       	push   $0x80107448
...
80103128:	68 4d 74 10 80       	push   $0x8010744d
...
801031bc:	ff 24 95 54 74 10 80 	jmp    *-0x7fef8bac(,%edx,4)
801031c3:	90                   	nop
...
801033e0:	00 00 00 
  initlock(&p->lock, "pipe");
801033e3:	68 68 74 10 80       	push   $0x80107468
...
801037c4:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801037c7:	c7 40 14 be 56 10 80 	movl   $0x801056be,0x14(%eax)
...
80103876:	68 6d 74 10 80       	push   $0x8010746d
...
801038a3:	e8 48 30 00 00       	call   801068f0 <setupkvm>
...
801038c1:	e8 7a 31 00 00       	call   80106a40 <inituvm>
  p->sz = PGSIZE;
...
8010392f:	68 8d 74 10 80       	push   $0x8010748d
80103934:	50                   	push   %eax
80103935:	e8 56 0d 00 00       	call   80104690 <safestrcpy>
  p->cwd = namei("/");
8010393a:	c7 04 24 96 74 10 80 	movl   $0x80107496,(%esp)
...
80103973:	68 74 74 10 80       	push   $0x80107474
...
801039a1:	e8 da 31 00 00       	call   80106b80 <allocuvm>
...
801039c0:	e8 db 2f 00 00       	call   801069a0 <switchuvm>
  return 0;
...
801039dc:	e8 8f 32 00 00       	call   80106c70 <deallocuvm>
...
80103a16:	e8 35 33 00 00       	call   80106d50 <copyuvm>
...
80103b5c:	83 c3 7c             	add    $0x7c,%ebx
      ...
      proc = p;
      switchuvm(p);
80103b5f:	e8 3c 2e 00 00       	call   801069a0 <switchuvm>
      p->state = RUNNING;
...
80103b7a:	e8 6c 0b 00 00       	call   801046eb <swtch>
      switchkvm();
80103b7f:	e8 fc 2d 00 00       	call   80106980 <switchkvm>
...
80103c27:	68 98 74 10 80       	push   $0x80107498
...
80103c34:	68 c4 74 10 80       	push   $0x801074c4
...
80103c41:	68 b6 74 10 80       	push   $0x801074b6
...
80103c4e:	68 aa 74 10 80       	push   $0x801074aa
...
80103d8d:	68 e5 74 10 80       	push   $0x801074e5
...
80103d9a:	68 d8 74 10 80       	push   $0x801074d8
...
80103e96:	68 f7 74 10 80       	push   $0x801074f7
...
80103ea3:	68 f1 74 10 80       	push   $0x801074f1
...
80103f30:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f37:	e8 64 2d 00 00       	call   80106ca0 <freevm>
        p->pid = 0;
...
801040ab:	68 46 74 10 80       	push   $0x80107446
...
801040ce:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
801040d1:	ba 08 75 10 80       	mov    $0x80107508,%edx
  uint pc[10];
...
801040d8:	8b 14 85 40 75 10 80 	mov    -0x7fef8ac0(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801040df:	b8 08 75 10 80       	mov    $0x80107508,%eax
...
801040f1:	68 0c 75 10 80       	push   $0x8010750c
...
8010412d:	68 69 6f 10 80       	push   $0x80106f69
...
8010415a:	68 58 75 10 80       	push   $0x80107558
...
8010433b:	68 63 75 10 80       	push   $0x80107563
...
8010443f:	68 82 75 10 80       	push   $0x80107582
...
8010444c:	68 6b 75 10 80       	push   $0x8010756b
...
8010447e:	68 89 75 10 80       	push   $0x80107589
...
8010489c:	8b 0c 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%ecx
...
801048c0:	68 91 75 10 80       	push   $0x80107591
...
80104a34:	68 34 76 10 80       	push   $0x80107634
...
80104a4c:	68 33 76 10 80       	push   $0x80107633
...
80104a61:	68 27 76 10 80       	push   $0x80107627
...
80104a6e:	68 36 76 10 80       	push   $0x80107636
...
80104a7b:	68 18 76 10 80       	push   $0x80107618
...
80104d02:	0f 88 e2 00 00 00    	js     80104dea <sys_link+0x11a>
  ...
  begin_op();
80104d08:	e8 d3 de ff ff       	call   80102be0 <begin_op>
  if((ip = namei(old)) == 0){
80104d0d:	83 ec 0c             	sub    $0xc,%esp
80104d10:	ff 75 d4             	pushl  -0x2c(%ebp)
80104d13:	e8 78 d1 ff ff       	call   80101e90 <namei>
...
80104d5b:	e8 50 d1 ff ff       	call   80101eb0 <nameiparent>
...
80104d83:	e8 48 d0 ff ff       	call   80101dd0 <dirlink>
...
80104d93:	e8 38 cb ff ff       	call   801018d0 <iunlockput>
  iput(ip);
80104d98:	89 1c 24             	mov    %ebx,(%esp)
80104d9b:	e8 f0 c9 ff ff       	call   80101790 <iput>

  end_op();
80104da0:	e8 ab de ff ff       	call   80102c50 <end_op>
...
80104dbc:	e8 0f cb ff ff       	call   801018d0 <iunlockput>
    goto bad;
...
80104ddd:	e8 ee ca ff ff       	call   801018d0 <iunlockput>
  end_op();
80104de2:	e8 69 de ff ff       	call   80102c50 <end_op>
  return -1;
...
80104e04:	e8 c7 ca ff ff       	call   801018d0 <iunlockput>
    end_op();
80104e09:	e8 42 de ff ff       	call   80102c50 <end_op>
    return -1;
...
80104e16:	eb 92                	jmp    80104daa <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80104e18:	e8 33 de ff ff       	call   80102c50 <end_op>
    return -1;
...
80104e3f:	e8 cc f9 ff ff       	call   80104810 <argstr>
...
80104e4f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80104e52:	e8 89 dd ff ff       	call   80102be0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104e57:	83 ec 08             	sub    $0x8,%esp
80104e5a:	53                   	push   %ebx
80104e5b:	ff 75 c0             	pushl  -0x40(%ebp)
80104e5e:	e8 4d d0 ff ff       	call   80101eb0 <nameiparent>
...
80104e7d:	58                   	pop    %eax
80104e7e:	5a                   	pop    %edx
80104e7f:	68 34 76 10 80       	push   $0x80107634
80104e84:	53                   	push   %ebx
80104e85:	e8 c6 cc ff ff       	call   80101b50 <namecmp>
...
80104e98:	68 33 76 10 80       	push   $0x80107633
80104e9d:	53                   	push   %ebx
80104e9e:	e8 ad cc ff ff       	call   80101b50 <namecmp>
...
80104eb7:	e8 b4 cc ff ff       	call   80101b70 <dirlookup>
...
80104f22:	e8 a9 c9 ff ff       	call   801018d0 <iunlockput>
...
80104f37:	e8 94 c9 ff ff       	call   801018d0 <iunlockput>

  end_op();
80104f3c:	e8 0f dd ff ff       	call   80102c50 <end_op>
...
80104f71:	e8 aa c9 ff ff       	call   80101920 <readi>
...
80104f89:	e8 42 c9 ff ff       	call   801018d0 <iunlockput>
    goto bad;
...
80104f97:	e8 34 c9 ff ff       	call   801018d0 <iunlockput>
  end_op();
80104f9c:	e8 af dc ff ff       	call   80102c50 <end_op>
  return -1;
...
80104fd6:	e9 6b ff ff ff       	jmp    80104f46 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
80104fdb:	e8 70 dc ff ff       	call   80102c50 <end_op>
    return -1;
...
80104fed:	68 58 76 10 80       	push   $0x80107658
...
80104ffa:	68 6a 76 10 80       	push   $0x8010766a
...
80105007:	68 46 76 10 80       	push   $0x80107646
...
8010502f:	e8 dc f7 ff ff       	call   80104810 <argstr>
...
80105048:	e8 33 f7 ff ff       	call   80104780 <argint>
...
80105052:	0f 88 85 00 00 00    	js     801050dd <sys_open+0xbd>
  ...
  begin_op();
80105058:	e8 83 db ff ff       	call   80102be0 <begin_op>
...
8010506d:	e8 1e ce ff ff       	call   80101e90 <namei>
...
801050d0:	e8 fb c7 ff ff       	call   801018d0 <iunlockput>
    end_op();
801050d5:	e8 76 db ff ff       	call   80102c50 <end_op>
    return -1;
...
801050dd:	8d 65 f4             	lea    -0xc(%ebp),%esp
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    end_op();
    return -1;
801050e0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
...
8010510b:	75 89                	jne    80105096 <sys_open+0x76>
      end_op();
8010510d:	e8 3e db ff ff       	call   80102c50 <end_op>
      return -1;
80105112:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105117:	eb 40                	jmp    80105159 <sys_open+0x139>
...
8010514a:	f7 d2                	not    %edx
8010514c:	88 56 08             	mov    %dl,0x8(%esi)
8010514f:	80 66 08 01          	andb   $0x1,0x8(%esi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105153:	a8 03                	test   $0x3,%al
80105155:	0f 95 46 09          	setne  0x9(%esi)
  return fd;
}
80105159:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010515c:	89 d8                	mov    %ebx,%eax
8010515e:	5b                   	pop    %ebx
8010515f:	5e                   	pop    %esi
80105160:	5f                   	pop    %edi
80105161:	5d                   	pop    %ebp
...
80105183:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105186:	e8 55 da ff ff       	call   80102be0 <begin_op>
...
801051bf:	e8 0c c7 ff ff       	call   801018d0 <iunlockput>
  end_op();
801051c4:	e8 87 da ff ff       	call   80102c50 <end_op>
  return 0;
...
801051cf:	c3                   	ret    
  ...
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    end_op();
801051d0:	e8 7b da ff ff       	call   80102c50 <end_op>
    return -1;
...
801051e3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801051e6:	e8 f5 d9 ff ff       	call   80102be0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
80105209:	e8 72 f5 ff ff       	call   80104780 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
8010521e:	e8 5d f5 ff ff       	call   80104780 <argint>
  char *path;
  int major, minor;
...
8010524e:	e8 7d c6 ff ff       	call   801018d0 <iunlockput>
  end_op();
80105253:	e8 f8 d9 ff ff       	call   80102c50 <end_op>
  return 0;
...
80105297:	e8 f4 cb ff ff       	call   80101e90 <namei>
...
801052a9:	e8 b2 c3 ff ff       	call   80101660 <ilock>
  if(ip->type != T_DIR){
...
801052bc:	e8 7f c4 ff ff       	call   80101740 <iunlock>
  iput(proc->cwd);
801052c1:	58                   	pop    %eax
801052c2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052c8:	ff 70 68             	pushl  0x68(%eax)
801052cb:	e8 c0 c4 ff ff       	call   80101790 <iput>
  end_op();
801052d0:	e8 7b d9 ff ff       	call   80102c50 <end_op>
  proc->cwd = ip;
...
801052f4:	e8 d7 c5 ff ff       	call   801018d0 <iunlockput>
    end_op();
801052f9:	e8 52 d9 ff ff       	call   80102c50 <end_op>
    return -1;
...
80105309:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
    end_op();
80105310:	e8 3b d9 ff ff       	call   80102c50 <end_op>
    return -1;
...
80105335:	e8 d6 f4 ff ff       	call   80104810 <argstr>
...
8010534d:	e8 2e f4 ff ff       	call   80104780 <argint>
...
80105378:	e8 33 f1 ff ff       	call   801044b0 <memset>
...
8010538e:	e8 6d f3 ff ff       	call   80104700 <fetchint>
...
801053eb:	e8 f0 b5 ff ff       	call   801009e0 <exec>
...
80105411:	e8 aa f3 ff ff       	call   801047c0 <argptr>
...
80105428:	e8 43 df ff ff       	call   80103370 <pipealloc>
...
{
  return fork();
801054c4:	e9 27 e5 ff ff       	jmp    801039f0 <fork>
...
801054d3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054d6:	e8 85 e7 ff ff       	call   80103c60 <exit>
...
{
  return wait();
801054e4:	e9 c7 e9 ff ff       	jmp    80103eb0 <wait>
...
8010550e:	e8 ed ea ff ff       	call   80104000 <kill>
...
80105567:	e8 14 e4 ff ff       	call   80103980 <growproc>
...
80105585:	eb ec                	jmp    80105573 <sys_sbrk+0x33>
...
801055dd:	e8 0e e8 ff ff       	call   80103df0 <sleep>
...
80105606:	e8 55 ee ff ff       	call   80104460 <release>
      return -1;
...
80105628:	e8 33 ee ff ff       	call   80104460 <release>
  return 0;
...
8010565e:	e8 fd ed ff ff       	call   80104460 <release>
  return xticks;
}
...
80105694:	e8 07 dc ff ff       	call   801032a0 <picenable>
}
...
801056e0:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
801056e7:	b9 08 00 00 00       	mov    $0x8,%ecx
801056ec:	c6 04 c5 24 4d 11 80 	movb   $0x0,-0x7feeb2dc(,%eax,8)
801056f3:	00 
801056f4:	66 89 0c c5 22 4d 11 	mov    %cx,-0x7feeb2de(,%eax,8)
801056fb:	80 
801056fc:	c6 04 c5 25 4d 11 80 	movb   $0x8e,-0x7feeb2db(,%eax,8)
80105703:	8e 
80105704:	66 89 14 c5 20 4d 11 	mov    %dx,-0x7feeb2e0(,%eax,8)
8010570b:	80 
8010570c:	c1 ea 10             	shr    $0x10,%edx
8010570f:	66 89 14 c5 26 4d 11 	mov    %dx,-0x7feeb2da(,%eax,8)
80105716:	80 
void
tvinit(void)
{
...
80105721:	a1 0c a1 10 80       	mov    0x8010a10c,%eax
...
80105729:	ba 08 00 00 00       	mov    $0x8,%edx
  ...
  initlock(&tickslock, "time");
8010572e:	68 79 76 10 80       	push   $0x80107679
80105733:	68 e0 4c 11 80       	push   $0x80114ce0
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105738:	66 89 15 22 4f 11 80 	mov    %dx,0x80114f22
8010573f:	c6 05 24 4f 11 80 00 	movb   $0x0,0x80114f24
80105746:	66 a3 20 4f 11 80    	mov    %ax,0x80114f20
8010574c:	c1 e8 10             	shr    $0x10,%eax
8010574f:	c6 05 25 4f 11 80 ef 	movb   $0xef,0x80114f25
80105756:	66 a3 26 4f 11 80    	mov    %ax,0x80114f26

  initlock(&tickslock, "time");
8010575c:	e8 ff ea ff ff       	call   80104260 <initlock>
}
...
801057c0:	ff 24 85 20 77 10 80 	jmp    *-0x7fef88e0(,%eax,4)
801057c7:	89 f6                	mov    %esi,%esi
801057c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
801057d0:	e8 1b cf ff ff       	call   801026f0 <cpunum>
...
801057d7:	0f 84 b3 01 00 00    	je     80105990 <trap+0x1f0>
  ...
  case T_IRQ0 + IRQ_COM1:
    uartintr();
    lapiceoi();
801057dd:	e8 ae cf ff ff       	call   80102790 <lapiceoi>
  }
...
80105847:	e8 a4 ce ff ff       	call   801026f0 <cpunum>
...
80105863:	68 dc 76 10 80       	push   $0x801076dc
...
80105888:	0f 85 69 ff ff ff    	jne    801057f7 <trap+0x57>
    exit();
8010588e:	e8 cd e3 ff ff       	call   80103c60 <exit>
...
801058e0:	5d                   	pop    %ebp
    ...
    if(proc->killed)
      exit();
801058e1:	e9 7a e3 ff ff       	jmp    80103c60 <exit>
...
801058f4:	0f 85 07 ff ff ff    	jne    80105801 <trap+0x61>
    yield();
801058fa:	e8 b1 e4 ff ff       	call   80103db0 <yield>
...
80105912:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105918:	e8 b3 cc ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
8010591d:	e8 6e ce ff ff       	call   80102790 <lapiceoi>
    break;
...
80105947:	e8 a4 cd ff ff       	call   801026f0 <cpunum>
8010594c:	57                   	push   %edi
8010594d:	56                   	push   %esi
8010594e:	50                   	push   %eax
8010594f:	68 84 76 10 80       	push   $0x80107684
80105954:	e8 07 ad ff ff       	call   80100660 <cprintf>
            cpunum(), tf->cs, tf->eip);
    lapiceoi();
80105959:	e8 32 ce ff ff       	call   80102790 <lapiceoi>
    break;
...
80105970:	e8 bb c6 ff ff       	call   80102030 <ideintr>
    lapiceoi();
80105975:	e8 16 ce ff ff       	call   80102790 <lapiceoi>
    break;
...
801059b7:	e8 a4 ea ff ff       	call   80104460 <release>
...
801059ca:	e8 21 cd ff ff       	call   801026f0 <cpunum>
...
801059d8:	68 a8 76 10 80       	push   $0x801076a8
801059dd:	e8 7e ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
801059e2:	83 c4 14             	add    $0x14,%esp
801059e5:	68 7e 76 10 80       	push   $0x8010767e
...
80105a45:	e8 66 cd ff ff       	call   801027b0 <microdelay>
{
  int i;
...
80105ae1:	e8 ba d7 ff ff       	call   801032a0 <picenable>
  ioapicenable(IRQ_COM1, 0);
80105ae6:	59                   	pop    %ecx
80105ae7:	5b                   	pop    %ebx
80105ae8:	6a 00                	push   $0x0
80105aea:	6a 04                	push   $0x4
80105aec:	bb a0 77 10 80       	mov    $0x801077a0,%ebx
80105af1:	e8 9a c7 ff ff       	call   80102290 <ioapicenable>
...
80105b6b:	e8 70 ac ff ff       	call   801007e0 <consoleintr>
}
...
80106634:	e8 47 be ff ff       	call   80102480 <kalloc>
...
8010664a:	e8 61 de ff ff       	call   801044b0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066ed:	68 a8 77 10 80       	push   $0x801077a8
...
80106744:	e8 87 bb ff ff       	call   801022d0 <kfree>
      *pte = 0;
...
8010678c:	68 72 71 10 80       	push   $0x80107172
80106791:	e8 da 9b ff ff       	call   80100370 <panic>
...
801067a6:	83 ec 14             	sub    $0x14,%esp
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
801067a9:	e8 42 bf ff ff       	call   801026f0 <cpunum>
...
801068f5:	e8 86 bb ff ff       	call   80102480 <kalloc>
...
80106910:	e8 9b db ff ff       	call   801044b0 <memset>
...
80106940:	72 d6                	jb     80106918 <setupkvm+0x28>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
801069a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801069aa:	e8 31 da ff ff       	call   801043e0 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801069af:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801069b5:	b9 67 00 00 00       	mov    $0x67,%ecx
801069ba:	8d 50 08             	lea    0x8(%eax),%edx
801069bd:	66 89 88 a0 00 00 00 	mov    %cx,0xa0(%eax)
801069c4:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801069cb:	c6 80 a5 00 00 00 89 	movb   $0x89,0xa5(%eax)
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801069d2:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
801069d9:	89 d1                	mov    %edx,%ecx
801069db:	c1 ea 18             	shr    $0x18,%edx
801069de:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
801069e4:	ba 10 00 00 00       	mov    $0x10,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801069e9:	c1 e9 10             	shr    $0x10,%ecx
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
801069ec:	66 89 50 10          	mov    %dx,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801069f0:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801069f7:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
...
801069fd:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106a02:	8b 52 08             	mov    0x8(%edx),%edx
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
80106a05:	66 89 48 6e          	mov    %cx,0x6e(%eax)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106a09:	81 c2 00 10 00 00    	add    $0x1000,%edx
80106a0f:	89 50 0c             	mov    %edx,0xc(%eax)
}
...
80106a12:	b8 30 00 00 00       	mov    $0x30,%eax
80106a17:	0f 00 d8             	ltr    %ax
  ...
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
80106a1a:	8b 43 04             	mov    0x4(%ebx),%eax
80106a1d:	85 c0                	test   %eax,%eax
80106a1f:	74 11                	je     80106a32 <switchuvm+0x92>
    panic("switchuvm: no pgdir");
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106a21:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106a26:	0f 22 d8             	mov    %eax,%cr3
  popcli();
}
80106a29:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106a2c:	c9                   	leave  
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106a2d:	e9 de d9 ff ff       	jmp    80104410 <popcli>
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
...
80106a35:	68 ae 77 10 80       	push   $0x801077ae
80106a3a:	e8 31 99 ff ff       	call   80100370 <panic>
80106a3f:	90                   	nop
...
80106a89:	e8 e2 fb ff ff       	call   80106670 <mappages>
  memmove(mem, init, sz);
...
80106aa9:	68 c2 77 10 80       	push   $0x801077c2
...
80106b03:	e8 e8 fa ff ff       	call   801065f0 <walkpgdir>
...
80106b31:	e8 ea ad ff ff       	call   80101920 <readi>
...
80106b5d:	68 dc 77 10 80       	push   $0x801077dc
...
80106b6a:	68 80 78 10 80       	push   $0x80107880
...
80106b8e:	78 7b                	js     80106c0b <allocuvm+0x8b>
    return 0;
  if(newsz < oldsz)
...
80106b93:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80106b96:	72 75                	jb     80106c0d <allocuvm+0x8d>
    return oldsz;

  a = PGROUNDUP(oldsz);
80106b98:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106b9e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106ba4:	39 df                	cmp    %ebx,%edi
80106ba6:	77 43                	ja     80106beb <allocuvm+0x6b>
80106ba8:	eb 6e                	jmp    80106c18 <allocuvm+0x98>
...
80106bbb:	e8 f0 d8 ff ff       	call   801044b0 <memset>
...
80106bd5:	e8 96 fa ff ff       	call   80106670 <mappages>
80106bda:	83 c4 10             	add    $0x10,%esp
80106bdd:	85 c0                	test   %eax,%eax
80106bdf:	78 47                	js     80106c28 <allocuvm+0xa8>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80106be7:	39 df                	cmp    %ebx,%edi
80106be9:	76 2d                	jbe    80106c18 <allocuvm+0x98>
    mem = kalloc();
80106beb:	e8 90 b8 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106bf2:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106bf4:	75 ba                	jne    80106bb0 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106bf6:	83 ec 0c             	sub    $0xc,%esp
80106bf9:	68 fa 77 10 80       	push   $0x801077fa
80106bfe:	e8 5d 9a ff ff       	call   80100660 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80106c06:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106c09:	77 4f                	ja     80106c5a <allocuvm+0xda>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
...
80106c2b:	68 12 78 10 80       	push   $0x80107812
80106c30:	e8 2b 9a ff ff       	call   80100660 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80106c38:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106c3b:	76 0d                	jbe    80106c4a <allocuvm+0xca>
80106c3d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106c40:	8b 45 08             	mov    0x8(%ebp),%eax
80106c43:	89 fa                	mov    %edi,%edx
80106c45:	e8 b6 fa ff ff       	call   80106700 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106c58:	eb b3                	jmp    80106c0d <allocuvm+0x8d>
80106c5a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106c5d:	8b 45 08             	mov    0x8(%ebp),%eax
80106c60:	89 fa                	mov    %edi,%edx
80106c62:	e8 99 fa ff ff       	call   80106700 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106c69:	eb a2                	jmp    80106c0d <allocuvm+0x8d>
80106c6b:	90                   	nop
...
80106c80:	5d                   	pop    %ebp
80106c81:	e9 7a fa ff ff       	jmp    80106700 <deallocuvm.part.0>
...
80106cb9:	e8 42 fa ff ff       	call   80106700 <deallocuvm.part.0>
...
80106d0c:	68 2e 78 10 80       	push   $0x8010782e
...
80106d3f:	68 3f 78 10 80       	push   $0x8010783f
...
80106d56:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106d59:	e8 92 fb ff ff       	call   801068f0 <setupkvm>
80106d5e:	85 c0                	test   %eax,%eax
80106d60:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106d63:	0f 84 a0 00 00 00    	je     80106e09 <copyuvm+0xb9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106d69:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d6c:	85 c9                	test   %ecx,%ecx
80106d6e:	0f 84 95 00 00 00    	je     80106e09 <copyuvm+0xb9>
80106d74:	31 f6                	xor    %esi,%esi
80106d76:	eb 4e                	jmp    80106dc6 <copyuvm+0x76>
80106d78:	90                   	nop
...
80106d93:	e8 c8 d7 ff ff       	call   80104560 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106d98:	58                   	pop    %eax
80106d99:	5a                   	pop    %edx
80106d9a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106d9d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106da0:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106da5:	53                   	push   %ebx
80106da6:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106dac:	52                   	push   %edx
80106dad:	89 f2                	mov    %esi,%edx
80106daf:	e8 bc f8 ff ff       	call   80106670 <mappages>
80106db4:	83 c4 10             	add    $0x10,%esp
80106db7:	85 c0                	test   %eax,%eax
80106db9:	78 39                	js     80106df4 <copyuvm+0xa4>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106dbb:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106dc1:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106dc4:	76 43                	jbe    80106e09 <copyuvm+0xb9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106dc6:	8b 45 08             	mov    0x8(%ebp),%eax
80106dc9:	31 c9                	xor    %ecx,%ecx
80106dcb:	89 f2                	mov    %esi,%edx
80106dcd:	e8 1e f8 ff ff       	call   801065f0 <walkpgdir>
80106dd2:	85 c0                	test   %eax,%eax
80106dd4:	74 3e                	je     80106e14 <copyuvm+0xc4>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106dd6:	8b 18                	mov    (%eax),%ebx
80106dd8:	f6 c3 01             	test   $0x1,%bl
80106ddb:	74 44                	je     80106e21 <copyuvm+0xd1>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106ddd:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106ddf:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106de5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106deb:	e8 90 b6 ff ff       	call   80102480 <kalloc>
80106df0:	85 c0                	test   %eax,%eax
80106df2:	75 8c                	jne    80106d80 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
80106df7:	ff 75 e0             	pushl  -0x20(%ebp)
80106dfa:	e8 a1 fe ff ff       	call   80106ca0 <freevm>
  return 0;
80106dff:	83 c4 10             	add    $0x10,%esp
80106e02:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
80106e17:	68 49 78 10 80       	push   $0x80107849
80106e1c:	e8 4f 95 ff ff       	call   80100370 <panic>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106e21:	83 ec 0c             	sub    $0xc,%esp
80106e24:	68 63 78 10 80       	push   $0x80107863
80106e29:	e8 42 95 ff ff       	call   80100370 <panic>
...
80106e3e:	e8 ad f7 ff ff       	call   801065f0 <walkpgdir>
  if((*pte & PTE_P) == 0)
